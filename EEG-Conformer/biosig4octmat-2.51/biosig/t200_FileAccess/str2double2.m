...
%%	$Id: str2double.m 2205 2009-10-27 12:18:15Z schloegl $
...
if exist('str2double_mex','file')
	if nargin>3, 
		s(s==ddelim) = '.';
	end;
	if nargin>2,
		[num,status,strarray] = str2double_mex(s,cdelim,rdelim);
	else if nargin>1,
		[num,status,strarray] = str2double_mex(s,cdelim);
	else
		[num,status,strarray] = str2double_mex(s);
	end; 		 
	return; 
end; 
