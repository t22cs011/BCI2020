...
function [pval, f, df_b, df_w] = anova (y, g)
  ...
  if (nargout == 0)
    ...
    fprintf(1,'\n');
    fprintf(1,'One-way ANOVA Table:\n');
    fprintf(1,'\n');
    fprintf(1,'Source of Variation   Sum of Squares    df  Empirical Var\n');
    fprintf(1,'^^^^^^^^^^^^^^^^^^^^^^^^^^^^*\n');
    fprintf(1,'Between Groups       %15.4f  %4d  %13.4f\n', SSB, df_b, v_b);
    fprintf(1,'Within Groups        %15.4f  %4d  %13.4f\n', SSW, df_w, v_w);
    fprintf(1,'---------------------------------------------------------\n');
    fprintf(1,'Total                %15.4f  %4d\n', SST, n - 1);
    fprintf(1,'\n');
    fprintf(1,'Test Statistic f     %15.4f\n', f);
    fprintf(1,'p-value              %15.4f\n', pval);
    fprintf(1,'\n');
  end
